...
This model was derived back in LRHW3 by backward selecting with p-value criterion. I know they said to use the non-binned dataset, but I think it should be okay for the Logistic Regression model we are comparing to be built on the binned set. If it seems like an issue, a new LR can always be built on the non binned set and then backward selected.  
  
  If anyone got a better model than this in LRHW3 let me know, but I feel like the modeling portion of that HW was pretty cut and dry.
